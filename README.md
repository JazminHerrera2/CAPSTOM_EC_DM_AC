...
> **Configuración local:** consulta la guía paso a paso [`GUIA_ARRANQUE_LOCAL.md`](./GUIA_ARRANQUE_LOCAL.md) para levantar Docker, cargar la red vial y ejecutar la app Android.
